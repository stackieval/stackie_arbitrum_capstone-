...
/**
 * Wraps __{@link useReadContract}__ with `abi` set to __{@link forumScriptAbi}__
 */
export const useReadForumScriptundefined = /*#__PURE__*/ createUseReadContract({
  abi: forumScriptAbi,
})

/**
 * Wraps __{@link useReadContract}__ with `abi` set to __{@link forumScriptAbi}__ and `functionName` set to `"IS_SCRIPT"`
 */
export const useReadForumScriptIsScript = /*#__PURE__*/ createUseReadContract({
  abi: forumScriptAbi,
  functionName: 'IS_SCRIPT',
})

/**
 * Wraps __{@link useReadContract}__ with `abi` set to __{@link forumScriptAbi}__ and `functionName` set to `"forum"`
 */
export const useReadForumScriptForum = /*#__PURE__*/ createUseReadContract({
  abi: forumScriptAbi,
  functionName: 'forum',
})

/**
 * Wraps __{@link useWriteContract}__ with `abi` set to __{@link forumScriptAbi}__
 */
export const useWriteForumScriptundefined =
  /*#__PURE__*/ createUseWriteContract({ abi: forumScriptAbi })

/**
 * Wraps __{@link useWriteContract}__ with `abi` set to __{@link forumScriptAbi}__ and `functionName` set to `"run"`
 */
export const useWriteForumScriptRun = /*#__PURE__*/ createUseWriteContract({
  abi: forumScriptAbi,
  functionName: 'run',
})

/**
 * Wraps __{@link useWriteContract}__ with `abi` set to __{@link forumScriptAbi}__ and `functionName` set to `"setUp"`
 */
export const useWriteForumScriptSetUp = /*#__PURE__*/ createUseWriteContract({
  abi: forumScriptAbi,
  functionName: 'setUp',
})

/**
 * Wraps __{@link useSimulateContract}__ with `abi` set to __{@link forumScriptAbi}__
 */
export const useSimulateForumScriptundefined =
  /*#__PURE__*/ createUseSimulateContract({ abi: forumScriptAbi })

/**
 * Wraps __{@link useSimulateContract}__ with `abi` set to __{@link forumScriptAbi}__ and `functionName` set to `"run"`
 */
export const useSimulateForumScriptRun =
  /*#__PURE__*/ createUseSimulateContract({
    abi: forumScriptAbi,
    functionName: 'run',
  })
...
/**
 * Wraps __{@link useSimulateContract}__ with `abi` set to __{@link forumScriptAbi}__ and `functionName` set to `"setUp"`
 */
export const useSimulateForumScriptSetUp =
  /*#__PURE__*/ createUseSimulateContract({
    abi: forumScriptAbi,
    functionName: 'setUp',
  })
